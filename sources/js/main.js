...
const music_list = [
    {
        img : "sources/image/amedanseau.jpg",
        name : "L'âme dans l'eau",
        artist : "Mylène Farmer",
        music : "sources/music/mylene-farmer-lame-dans-leau.mp3"
    },
    {
        img : "sources/image/badhabits.jpg",
        name : "Bad Habits",
        artist : "Ed Sheeran",
        music : "sources/music/ed-sheeran-bad-habits.mp3"
    },
    {
...
function loadTrack(track_index){
    ...
    now_playing.textContent = "Piste " + (track_index + 1) + " sur " + music_list.length;
